...
var settings = {
    ...
    section_content = [
        ["<div>I am Romi Chandra and I create for creation's sake.</div>", "<div>You are <em>here</em>.</div>", "<div></div>", "<div></div>", "<div></div>", "<div></div>"],
        ["<div>I could waste your time</div>", "<div>by building a thorough website</div>", "<div>that would attempt to</div>", "<div>convince you that I know about <em>x</em></div>", "<div>and establish that <em>y</em> is important to me.</div>"],
        ["<div>But ultimately, my preference and skills</div>", "<div>are as temporary as every language I know</div>", "<div>and as fickle as every tool I use.</div>", "<div class='space'>As <em>temporary</em> as things</div>", "<div>that will be <em>useless</em> in 10 years.</div>", "<div class='space'>As <em>fickle</em> as things</div>", "<div>that can be learned by <em>anyone</em>.</div>"],
        ["<div>The things that last are not complete,</div>", "<div>they are <em>in progress</em>.</div>", "<div class='space'>So what I <em>will</em> tell you is that</div>", "<div>I am <em>in progress</em>.</div>"],
        ["<div>I hold on to my methods <em>loosely</em>,</div>", "<div>embrace <em>flexibility</em> and <em>modularity</em>,</div>", "<div>am willing to <em>learn</em>,</div>", "<div>expect to be <em>wrong</em>,</div>", "<div>and am <em>confident</em> when I’m right.</div>"],
        ["<div>If you want to see what I am doing <em>now</em>:</div>", '<div class="sans"><a href="http://jakealbaugh.com/blog/" target="_blank">Blog</a> / <a href="http://codepen.io/jakealbaugh" target="_blank">CodePen</a> / <a href="http://github.com/jakealbaugh" target="_blank">GitHub</a></div>', '<div class="space">Or, if you would like to contact me:</div>', '<div class="sans lower"><a href="http://twitter.com/jake_albaugh" target="_blank">@jake_albaugh</a> / <a href="mailto:jake.albaugh@gmail.com" target="_blank">jake.albaugh@gmail.com</a></div>']
    ],
    total_frames = 226;
