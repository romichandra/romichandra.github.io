function Site(e) {
    ...
    var a = {
        ...
        skrollrGo: function(e) {
            ...
            x = x - 0.2;
            console.log(x);
            a.background.element.style['filter'] = " blur(4.5px) hue-rotate(" + x + "deg)";
            a.background.element.style['-webkit-filter'] = " blur(4.5px) hue-rotate(" + x + "deg)";
...
var settings = {
        frames: {
            ...
            hi_path: "ardnahcimor/images/bg/rl/",
            prefix: "img",
            ext: ".jpg"
        },
        progress: {
    ...
    section_content = [
        ...
        ["<div>If you think I am nothing like <em>you</em>,</div>", "<div>We would make a great <em>team</em>.</div>", "<div class='space'>I have linked some of my <em>social</em></div>", "<div> and <em>professional</em> profiles,</div>","<div>feel free to share your <em>thoughts</em>.</div>", "<div class='space'> I do <em>judge</em>, but I also <em>accept</em>.</div>"],
        ['<div>Check out what people say about me on</div><div> <a href="https://yourstory.com/2017/01/elune-technologies/" target="_blank">YourStory</a></div>','<div class="space">and some of the my professional projects on</div>','<div>Android :</div><div><a href="https://play.google.com/store/apps/details?id=com.touchtalent.bobbleapp" target="_blank">Bobble</a>/<a href="https://play.google.com/store/apps/details?id=com.goibibo" target="_blank">Goibibo</a>/<a href="https://play.google.com/store/apps/details?id=netmedicines.com.firstaid" target="_blank">firstAid</a>/<a href="https://play.google.com/store/apps/details?id=com.ingoibibo" target="_blank">Ingoibibo</a>/<a href="https://play.google.com/store/apps/details?id=com.elune.sajid.myapplication" target="_blank">Docbox</a></div>','<div class="space">iOS :</div><div><a href="https://itunes.apple.com/in/app/ingoibibo/id1019426231" target="_blank">Ingoibibo</a>/<a href="https://itunes.apple.com/us/app/docbox-elune/id1147672610" target="_blank">Docbox</a></div>','<div class="space">Web :</div><div><a href="https://in.goibibo.com/" target="_blank">Ingoibibo</a>/<a href="https://www.docbox.co.in" target="_blank">Docbox</a></div>'],
        ["<div>You can view my <a href='resume.pdf' target='_blank'>Resume</a></div>",'<div class="space">Or, if you would like to contact me:</div>', '<div><a href="mailto:romi.d.nerd@gmail.com" target="_blank">romi.d.nerd@gmail.com</a></div><div><a href="mailto:sensei.xml@gmail.com" target="_blank">sensei.xml@gmail.com</a></div>']
    ],
    total_frames = 202;
    start = 46, 
    stop = 196, 
